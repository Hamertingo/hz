...
/// is to be quiet.
///
/// `aria-hidden` because the word beside it is the name — read out, "Linear
/// Linear". Both of its call sites draw it beside a label, and the inbox's
/// source tab is the third.
