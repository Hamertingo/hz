...
///
/// A discovered list is not named here — it is every model every provider the
/// reader has logged into serves — so it has no bound and a menu of all of them
/// is a menu nobody reads. This is where the reader decides which few they work
/// with; the picker draws that decision.
///
