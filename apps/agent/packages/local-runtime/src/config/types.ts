import type { AsrConfig, Config, ModelConfig, ProviderAuthMode } from '@hz/config';
...
/** BYOK: user's own MiniMax API key (mirrors `MinimaxApiConfig` in @hz/config). */
...
/** BYOK: user-created external provider (mirrors `CustomProviderConfig` in @hz/config). */
...
export interface LocalRuntimeConfig {
  ...
  /**
   * Not a setting: the fallbacks `@hz/config` recorded while parsing the
