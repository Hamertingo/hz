import { resolveCanonicalSubagentRole } from '@hz/agent-tools/desktop/subagent-roles';
import type { LocalTaskRunResult, VerificationReport } from '@hz/agent-tools/desktop';
