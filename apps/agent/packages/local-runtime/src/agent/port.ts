...
} from '@hz/agent-tools/desktop/subagent-roles';
import type { AgentReferenceReadScope, AgentReferenceResolver } from '@hz/shared';

export type { AgentReferenceReadScope, AgentReferenceResolver } from '@hz/shared';
