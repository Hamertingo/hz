 ...
 * are typed as `ToolCall` from `@hz/agent-core/protocol/agent-message`. That
 ...
 */
import { parseMediaTags, placeholderMediaTags } from '@hz/shared';
import { ToolCallStatus, type ToolCall } from '@hz/agent-core/protocol/agent-message';
