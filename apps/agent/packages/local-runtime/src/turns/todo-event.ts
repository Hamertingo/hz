import { buildStreamRespEvent } from '@hz/agent-core/event-bridge';
import { MsgType, RespDataType, type AgentMessage } from '@hz/agent-core/protocol/agent-message';
import type { LocalRuntimeToolContext, LocalTodoWriteToolInput } from '@hz/agent-tools/desktop';
