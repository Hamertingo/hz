...
import { resolveBashEnvPolicy, type BashEnvPolicy } from '@hz/agent-core/bash-subprocess-env';
...
# Managed by Hz Agent. Do not edit.
#
      ...
      try {
        ...
        throw new Error(
          `The recoverable-delete rm shim at ${shimPath} is missing or not executable and could not be re-seeded. ` +
            ...
            'Check that the Hz Agent data directory is writable, then restart the app to re-seed the shim.',
          { cause },
        );
      }
    },
