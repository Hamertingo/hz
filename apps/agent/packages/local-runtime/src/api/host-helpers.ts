...
import type { PromptSnapshotSource } from "@hz/agent-core";
import type {
...
import {
  ...
  type AgentMessage,
  type RespData,
} from "@hz/agent-core/protocol/agent-message";
import type { ToolDiagnosticLogger as MatrixToolLogger } from "../observability/tool-logger.js";
import type { LocalMavisCronAdapter } from "@hz/agent-tools/desktop";
import type { RuntimeConversation } from "@hz/conversation-contract";
import type { CronStorePort } from "@hz/cron";
import type { PermissionRuleMatcher } from "@hz/permission";
import type { GlobalEventPayloadMap } from "@hz/shared/global-events";
...
export interface LocalRuntimeApiHostOptions {
  ...
  skillRegistryRoots?: import("@hz/skills").SkillSourceRoot[];
   ...
   * from `@hz/local-runtime` so the SDK does not enter the Electron main
