...
import { resolveAgentCapabilities, type AgentBuiltinSkillId } from '@hz/config';
...
import type { InternalTurnPromptReadRegistry, PromptSnapshotSource } from '@hz/agent-core';
