...
import { GOAL_CONFIG_DEFAULTS, resolveModelCallRoute } from '@hz/config';
...
function sameDataRoute(worker: EvaluatorRouteIdentity, evaluator: EvaluatorRouteIdentity): boolean {
  // Keep aligned with @hz/goal's model-port route check; this v2 seam compares two identities
