...
import { GOAL_VERIFIER_READONLY_PROFILE } from '@hz/config';
import type { PiBeforeToolCallHook } from '@hz/agent-core/pi-turn-runner';
import type { AgentExtension } from '@hz/agent-runtime';
import type { VerificationHostContext } from '@hz/goal';
