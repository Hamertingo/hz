import type { GlobalEvent } from '@hz/shared/global-events';
...
export function createProcessLocalApplication(
  ...
  return {
    ...
    skills: {
      ...
      setSkillEnabled: (input, enabled) =>
        options.skills.setSkillEnabled(input, enabled),
      getSkill: (input, skillOptions) =>
        options.skills.getSkill(input, skillOptions),
    },
