import { createMiniAppControlExtension } from "@hz/agent-extension";
import type {
  AgentExtension,
  InternalTurnPromptReadRegistry,
} from "@hz/agent-runtime";
import type { RunawayGuardOverride } from "@hz/config";
import {
  getRuntimeRegion,
...
import { isOrdinaryQuestionnaireResponseOrigin } from "@hz/shared/questionnaire";
