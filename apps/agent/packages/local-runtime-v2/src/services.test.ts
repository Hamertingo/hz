...
import { createAgentRuntime, type AgentExtension } from "@hz/agent-runtime";
import { baseCtx } from "../../agent-runtime/src/testing/fixtures.js";
import type { RuntimeTool } from "@hz/agent-core/tools";
import { LocalSkillToolDef } from "@hz/agent-tools/desktop";
import type {
  DatabaseLike,
...
vi.mock("@hz/config", async (importOriginal) => ({
  ...(await importOriginal<typeof import("@hz/config")>()),
