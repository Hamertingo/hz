...
import type { LocalBrowserAdapter, LocalBrowserToolExposure } from '@hz/agent-tools/desktop';
import type {
  MiniAppPresenter,
...
export type { LocalRuntimeAuthContext, LocalRuntimeConfig } from '@hz/local-runtime';
