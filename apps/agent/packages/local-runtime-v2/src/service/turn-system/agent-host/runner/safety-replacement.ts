import { toPiUserMessage, type PiHistoryChangedHookInput } from '@hz/agent-core/pi-turn-runner';
import { buildCompletedTerminalStatusEvent } from '@hz/agent-core/event-bridge';
import { RespDataType } from '@hz/agent-core/protocol/agent-message';
import { RUNTIME_EVENT_SCHEMA, RuntimeEventType } from '@hz/protocol';
