...
import { isRuntimeToolInputValid, type RuntimeTool } from '@hz/agent-core/tools';
import type { PluginHookRunResult } from '@hz/plugin-hooks';
...
): Pick<import('@hz/plugin-hooks').PluginHookEventInput, 'toolProvenance'> | object {
  const hostOwner =
