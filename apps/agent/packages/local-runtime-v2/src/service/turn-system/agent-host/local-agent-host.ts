import type { TurnAssemblyCtx, TurnEndHandler, TurnStartHandler } from '@hz/agent-runtime';
import { pluginHookEffort } from '@hz/plugin-hooks';
...
> implements AgentHost {
  ...
  private createExecutionInput(
    ...
    const pluginHostApprovalTargets = new Map<
      string,
      {
        readonly tool: import('@hz/agent-core/tools').RuntimeTool;
        readonly inputSchema: import('@hz/agent-core/tools').RuntimeTool['def']['schema'];
