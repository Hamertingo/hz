import { createAgentRuntime, type AgentExtension, type AgentRuntime } from '@hz/agent-runtime';
import { getLocalBashEnvironment } from '@hz/agent-tools';
...
> {
   ...
   * `@hz/agent-extension` adapters are not enabled by this factory.
   */
