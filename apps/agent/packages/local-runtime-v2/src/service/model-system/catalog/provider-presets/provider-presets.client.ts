import { DEFAULT_MODEL_PRESETS, getRuntimePresetKey, getRuntimeRegion } from '@hz/config';
import { MODELS_DEV_CATALOG_SOURCE_URL, type ModelsDevRegion } from '@hz/shared/models-dev';
