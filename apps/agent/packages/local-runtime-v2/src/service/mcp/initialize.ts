import type { MetricsClient } from '@hz/shared/local-runtime-logging/metrics';
import type { ObservabilityLogger } from '@hz/shared/local-runtime-diagnostics';
import { createMcpRuntimeLogger } from './logging.js';
import { McpConnectionPool } from '@hz/mcp/runtime/connection-pool';
import type { McpRuntimeLogger } from '@hz/mcp/runtime/types';
import type {
